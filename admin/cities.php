...
$result_db = mysqli_query($db,"SELECT COUNT(city.id) FROM city INNER JOIN  states ON city.s_id=states.id WHERE states.status=1"); 
...
$result = mysqli_query($db,"SELECT city.id,city.city_name,city.status FROM city INNER JOIN states ON city.s_id=states.id WHERE states.status=1  LIMIT $start_from, $limit");
?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <?php include 'header.php'; ?>
        <div class="navigation col-12  bg-light justify-content-center justify-content-sm-left ">
          <div class="btn-group justify-content-center justify-content-sm-left">  
            ...
            <a  class="btn btn-default navigator rounded-0 text-success"><i class="fa fa-flag"></i> Cities</a>
                ...
                <div class="card">
                  <div class="card-header with-border">
                    <div class="row ">
                      ...
                      <div class="col-6">
                        <label>Sort</label>
                        <select class="form-control rounded" name="sort" id="citylimit">
                    ...
                    <table id="example1" class="table table-bordered table-striped w-100">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" width="70">Cities Name</th>
                    ...
                    <div class="card-footer">
                      ...
                      <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end">
                          <li class="page-item <?php if($page==1){ echo "disabled";} ?>"><a class="page-link" href="cities.php?page=<?php $dec=1; $prev=$page-$dec; echo $prev; ?>" tabindex="-1" aria-disabled="true">Previous</a></li>
                          <?php
                          for ($i=1; $i<=$total_pages; $i++) {
                          ?>
                            <li class="page-item <?php if($page==$i){ echo 'active';} ?>"><a class="page-link" href="cities.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                          <?php
                          }
                          ?>
                            <li class="page-item <?php if($page==$total_pages){echo 'disabled';} ?>"><a class="page-link" href="cities.php?page=<?php $inc=1; $next=$page+$inc; echo $next; ?>">Next</a></li>
                        </ul> 
                      </nav>
                    </div>
                </div>
