...
$new = 1;
$result_db = mysqli_query($db,"SELECT COUNT(id) FROM  orders WHERE new = $new "); 
...
$result = mysqli_query($db,"SELECT * FROM orders INNER JOIN products ON orders.product_id=products.product_id  INNER JOIN customers ON orders.customer_id=customers.id WHERE new = $new ORDER BY orders.id DESC LIMIT $start_from, $limit");
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="card">
                                <div class="card-header with-border">
                                    <div class="row ">
                                        ...
                                        <div class="col-6">
                                            <label>Sort</label>
                                            <select class="form-control rounded" name="sort" id="newlimit">
                                ...
                                <div
                                    ...
                                    <table id="product" class="table table-bordered table-striped  text-sentance">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Received(order)</th>
                                            </tr>
                                        </thead>
                                        <tbody id="datatable">
                                            <?php
                                    ...
                                    ?>
                                            <tr id="<?php echo $row['order_id']; ?>">
                                                ...
                                                <td class="text-center"><a href="#<?php echo $row['order_id']; ?>" class="new-order"><i class="fa fa-eye btn btn-secondary"></i></a></td>
                                            </tr>
                                            <?php
                                      $num++;
                                    }
