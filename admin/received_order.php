...
$rec = 1;
$result_db = mysqli_query($db,"SELECT COUNT(id) FROM  orders WHERE new = $rec "); 
...
$result = mysqli_query($db,"SELECT * FROM orders INNER JOIN products ON orders.product_id=products.product_id  INNER JOIN customers ON orders.customer_id=customers.id WHERE received = $rec ORDER BY orders.id DESC LIMIT $start_from, $limit");
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="card">
                                <div class="card-header with-border">
                                    <div class="row ">
                                        ...
                                        <div class="col-6">
                                            <label>Sort</label>
                                            <select class="form-control rounded" name="sort" id="receivedlimit">
                                ...
                                <div
                                    class="box-body table-responsive table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl">
                                    ...
                                    ?>
                                            <tr id="<?php echo $row['order_id']; ?>">
                                                ...
                                                <td class="text-left"><i class="fa fa-rupee text-primary"></i> <?php echo $row['total_amount']; ?></td>
                                                ...
                                                <td class="text-center"><a href="view_order.php?order_id=<?php echo $row['order_id']; ?>"><i class="fa fa-eye btn btn-secondary"></i></a></td>
                                            </tr>
                                            <?php
                                      $num++;
                                    }
                                    ...
                                    ?>
                                            <tr>
                                                <td colspan="15">No new order yet !</td>
                                            </tr>
                                            <?php
                                  } 
                                  ?>
